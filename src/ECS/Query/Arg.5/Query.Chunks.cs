...
where T5 : struct
{
    ...
    SetChunks:
        ...
        var chunk1      = new Chunk<T1>(chunks1.components, count, start, archetype);
        var chunk2      = new Chunk<T2>(chunks2.components, count, start, archetype);
        var chunk3      = new Chunk<T3>(chunks3.components, count, start, archetype);
        var chunk4      = new Chunk<T4>(chunks4.components, count, start, archetype);
        var chunk5      = new Chunk<T5>(chunks5.components, count, start, archetype);
